      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="card mt-6">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href={personalInfo.github} target="_blank" rel="noreferrer" className="border border-slate-600 px-7 py-3 rounded-full font-bold flex items-center gap-2 hover:border-cyan-400 hover:text-cyan-400"><FaGithub /> GitHub</a>
            <a href={personalInfo.linkedin} target="_blank" rel="noreferrer" className="border border-slate-600 px-7 py-3 rounded-full font-bold flex items-center gap-2 hover:border-cyan-400 hover:text-cyan-400"><FaLinkedin /> LinkedIn</a>
          </div>
